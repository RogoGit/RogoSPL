...
; 16 = 4*3 + 4 - one full pixel with extra component
; 4 channels parallel
; r g b r
; g b r g
; b r g b
...
;b g r b
align 16
first_channel_bgrb: dd 0.131, 0.168, 0.189, 0.131
align 16
second_channel_bgrb: dd 0.543, 0.686, 0.769, 0.543
align 16
third_channel_bgrb: dd 0.272, 0.349, 0.393, 0.272

; g r b g
align 16
first_channel_grbg: dd 0.168, 0.189, 0.131, 0.168
align 16
second_channel_grbg: dd 0.686, 0.769, 0.543, 0.686
align 16
third_channel_grbg: dd 0.349, 0.393, 0.272, 0.349

;r b g r
align 16
first_channel_rbgr: dd 0.189, 0.131, 0.168, 0.189
align 16
second_channel_rbgr: dd 0.769, 0.543, 0.686, 0.769
align 16
third_channel_rbgr: dd 0.393, 0.272, 0.349, 0.393
...
; matrix data
%define xmm_1st_channel_bgrb xmm3
%define xmm_2nd_channel_bgrb xmm4
%define xmm_3rd_channel_bgrb xmm5

%define xmm_1st_channel_grbg xmm6
%define xmm_2nd_channel_grbg xmm7
%define xmm_3rd_channel_grbg xmm8

%define xmm_1st_channel_rbgr xmm9
%define xmm_2nd_channel_rbgr xmm10
%define xmm_3rd_channel_rbgr xmm11
...
; movaps - send packed data aligned 16
  ...
  movaps xmm_1st_channel_bgrb, [first_channel_bgrb]
  movaps xmm_2nd_channel_bgrb, [second_channel_bgrb]
  movaps xmm_3rd_channel_bgrb, [third_channel_bgrb]
 
  movaps xmm_1st_channel_grbg, [first_channel_grbg]
  movaps xmm_2nd_channel_grbg, [second_channel_grbg]
  movaps xmm_3rd_channel_grbg, [third_channel_grbg]
 
  movaps xmm_1st_channel_rbgr, [first_channel_rbgr]
  movaps xmm_2nd_channel_rbgr, [second_channel_rbgr]
  movaps xmm_3rd_channel_rbgr, [third_channel_rbgr]

sepia_filter_sse_loop:

  mov rdx, [pointer]      ; first pixel

  ; b g r b

  movd channel_blue, edx ; get  b g r b g r b g in bytes
  pmovzxbd channel_blue, channel_blue ;  b0 g0 r0 b1 in 4 bytes - convert byte to dword
  ...
  vfmadd231ps xmm_bgrb, channel_blue, xmm_1st_channel_bgrb ; xmm_bgrb += channel_blue * xmm_1st_channel_bgrb
  vfmadd231ps xmm_bgrb, channel_green, xmm_2nd_channel_bgrb ; xmm_bgrb += channel_green * xmm_2nd_channel_bgrb
  vfmadd231ps xmm_bgrb, channel_red, xmm_3rd_channel_bgrb ; xmm_bgrb += channel_red * xmm_3rd_channel_bgrb
...
; r1 r1 r2 r2
  ...
  vfmadd231ps xmm_grbg, channel_blue, xmm_1st_channel_grbg
  vfmadd231ps xmm_grbg, channel_green, xmm_2nd_channel_grbg
  vfmadd231ps xmm_grbg, channel_red, xmm_3rd_channel_grbg
 ...
 ; r2 r3 r3 r3
  ...
  vfmadd231ps xmm_rbgr, channel_blue, xmm_1st_channel_rbgr
  vfmadd231ps xmm_rbgr, channel_green, xmm_2nd_channel_rbgr
  vfmadd231ps xmm_rbgr, channel_red, xmm_3rd_channel_rbgr
...
; Convert Packed Single-Precision Floating-Point Values to Packed Signed Doubleword Integer Values - convertion
  ...
  packssdw xmm_bgrb, xmm_grbg ; r0 g0
  ...
  pextrq [pointer], xmm_bgrb, 0  ; Extract Qword
  pextrd [pointer + 8], xmm_bgrb, 2  ; Extract Dword
  lea pointer, [pointer + 12]
  cmp pointer, rsi
  jl sepia_filter_sse_loop
